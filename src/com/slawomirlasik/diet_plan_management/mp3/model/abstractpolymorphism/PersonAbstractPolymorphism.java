...
public abstract class PersonAbstractPolymorphism extends ExtensionAnnotationAssociationManager implements Serializable {
    ...
    public PersonAbstractPolymorphism(String name, String lastName, LocalDate birthDate) throws Exception {
        super();
        this.name = name;
