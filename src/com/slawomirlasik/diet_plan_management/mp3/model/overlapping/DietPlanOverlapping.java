...
public class DietPlanOverlapping extends ExtensionAnnotationAssociationManager implements Serializable {

    private LocalDate from;

    private LocalDate to;

    public DietPlanOverlapping() {
        super();
    }

    public DietPlanOverlapping(LocalDate startingDate) {
